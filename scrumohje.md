...
# Työjonot
    ...
    - Sprint Backlog = tehtävät, jotka valitaan kyseiseen sprinttiin
    - Tiimi työskentelee sprintin aikana valittujen tehtävien parissa
...
# Miksi Scrum toimii?
    ...
    - Joustava tapa ohjelmistokehitykselle ja kaikilla on oma roolinsa selvillä# Scrum-syklin yleiskuvaus
    - Jaetaan viikon / sprintin tehtävät ryhmän kesken teams puhelussa
    - Vaihdetaan scrum-masteria sprinttien vaihtuessa
    - käydään scrum-tapaamisissa tehdyt asiat ja mitä pitää saada tehtyä seuraavaan mennessä
